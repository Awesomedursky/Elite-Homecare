...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* 3. Hero Content */}
      {path === "about-us" ? (
        <div className="max-w-7xl mx-auto px-6 md:px-10  xl:px-0 flex flex-col lg:flex-row gap-x-10 gap-y-3 lg:gap-y-0 items-center lg:items-start justify-between w-full">
