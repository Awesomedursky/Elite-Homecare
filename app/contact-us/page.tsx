          ...
          <div className="bg-white rounded-2xl drop-shadow-[#D8E0E9] shadow-md border border-gray-100 p-3 sm:p-6 lg:p-8 md:h-[78vh] scrollbar-hide overflow-y-auto w-full lg:w-[60%]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full py-3 sm:py-4 bg-(--primary) hover:bg-(--dark-blue) disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer flex items-center justify-center gap-2 lg:min-h-13"
              >
                {isSubmitting ? (
                  <>
                    <svg
